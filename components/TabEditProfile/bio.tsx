    ...
    <View className="py-4 flex items-center">
      <View className="w-full rounded-[20px] border border-neutral-700">
        <View className="px-5 py-6">
          ...
          />
          <Gap height={4} />
          <Text className="text-xs text-neutral-900 mt-4 mb-2">Email</Text>
          <InputForm
            placeholder="Email"
          ...
          />
          <Gap height={4} />
          <Text className="text-xs text-neutral-900 mt-4 mb-2">Pendidikan</Text>
          <SelectList
            setSelected={(value: any) => handleChange("pendidikan", value)}
            data={educations}
            save="key"
            arrowicon={
          ...
          />
          <Gap height={4} />
          <Text className="text-xs text-neutral-900 mt-4 mb-2">Agama</Text>
          <SelectList
          ...
          <InputForm
            ...
            onChangeText={(value: any) => handleChange("tempatLahir", value)}
          />
          <Gap height={4} />
          <Text className="text-xs text-neutral-900 mt-4 mb-2">
            Tanggal Lahir
          ...
          <SelectList
            setSelected={(value: any) => handleChange("statusKawin", value)}
            data={marriedStatus}
            save="key"
            arrowicon={
              <Image source={icons.chevronDown} className="w-[3vh] h-[3vh]" />
          ...
          />
          <Gap height={4} />
          <Text className="text-xs text-neutral-900 mt-4 mb-2">Pekerjaan</Text>
          <InputForm
            placeholder="Pekerjaan"
            value={formData.pekerjaan}
            onChangeText={(value: any) => handleChange("pekerjaan", value)}
          />
          <Gap height={4} />
          <Text className="text-xs text-neutral-900 mt-4 mb-2">Kecamatan</Text>
          <SelectList
          ...
          />
          <Gap height={4} />
          <Text className="text-xs text-neutral-900 mt-4 mb-2">Alamat</Text>
          <InputForm
            type="address"
            placeholder="Alamat"
